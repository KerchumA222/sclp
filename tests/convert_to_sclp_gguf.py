...
def build_sclp4_blob(data_u16: np.ndarray, shape: list = None, sidecar_dist: int = 0) -> bytes:
...
def build_sclp6_blob(data_u16: np.ndarray, shape: list = None, sidecar_dist: int = 0) -> bytes:
